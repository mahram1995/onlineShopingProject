...
<body>
	...
	<form action="addressPaymentForOrderAction.jsp" method="post">
		...
		<div class="right-div">
			...
			<h5>*If you select online Payment then enter you transaction ID
				here otherwise leave this blank</h5>
		</div>
		<hr style="width: 100%">
		...
		<div class="left-div">
			...
			<input class="input-style" type="text" name="mobileNumber"
				laceholder="Enter mobile number" value="<%=rs2.getString(3)%>"
				required>
			<h5>*This mobile number will also updated to your profile</h5>
		</div>
		<div class="right-div">
			<h5>*If you enter wrong transaction id then your order will we
				can cancel!</h5>
