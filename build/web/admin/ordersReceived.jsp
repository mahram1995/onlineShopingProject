...
<body>
	...
	<table id="customers" style="padding: 2px;">
		...
		<tr>
			...
			<td><a
				href="cancelOrderAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Cancel
					<i class='fas fa-window-close'></i>
			</a></td>
			<td><a
				href="orderDeliveredAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Delivered
