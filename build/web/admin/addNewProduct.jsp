...
<body>
	...
	<form action="addNewProductAction.jsp" method="post">
		...
		<div class="right-div">
			...
			<input class="input-style" type="text" name="catagory" placeholder="Enter catagory" required="required" />
			<hr>
		</div>
       ...
       <script src="../css/jquery-3.6.0.min.js" type="text/javascript"></script>
