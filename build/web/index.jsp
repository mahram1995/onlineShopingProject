...
<body>
	...
	<div class="topnav sticky" style="background-color: #f5ce64">
		...
		<h2></h2>
		<a href="index.jsp">Home<i class="fa fa-institution"></i></a> <a
			href="">About <i class="fa fa-address-book"></i></a> <a
			href="login.jsp">Login <i class='fas fa-share-square'></i></a>
	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="login.jsp?id=<%=rs2.getString(1)%>">Add to
			...
			<tr>
				...
				<td><a href="login.jsp?id=<%=rs.getString(1)%>">Add to cart
