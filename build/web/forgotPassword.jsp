		...
		<div class='signup'>
			<form action="fogotPasswordAction.jsp" method="post">
				<input type="email" name="email" placeholder="Enter your email"
					required="required" /> <input type="number" name="mobileNumber"
					placeholder="Enter your mobile number" required="required" /> <select
					name="securityQuestion">
					<option value="what is your first name">what is your first
						name</option>
					...
					placeholder="Enter your new password" required="required" /> <input
