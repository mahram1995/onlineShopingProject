...
<table>
        <thead>
          <tr>
            ...
            <th style="width: 500px" scope="col">Product Name</th>
            <th style="width: 100px" scope="col">Category</th>
            <th style="width: 100px" scope="col"><i class="fa "></i> Price</th>
            <th style="width: 100px">Status</th>
            <th style="width: 100px" scope="col">Edit <i class='fas fa-pen-fancy'></i></th>
          </tr>
        </thead>
        <tbody>
       <%
